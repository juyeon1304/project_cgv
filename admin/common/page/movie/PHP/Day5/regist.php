...
<body>
    ...
    <form name="regform" id="regform" method="post" action="registP.php" onsubmit="return sendit()">
        ...
        <p><label>아이디 : <input type="text" name="userid" id="userid" maxlength="20" onkeydown='idchange()'></label> <input type="button" value="중복확인" onclick="idcheck()"></p>
        <p id="idchecktext"></p>
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" onkeyup="moveFocus()" onkeydown="ssnchange()"> - <input type="password" name="ssn2" id="ssn2" maxlength="7" onkeydown="ssnchange()"> <input type="button" value="주민등록번호 검증" onclick="ssnCheck()"></p>
